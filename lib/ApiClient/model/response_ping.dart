...
class ResponsePing {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'serviceAmount'] = serviceAmount;
      _json[r'openStation'] = openStation;
    if (lastUpdate != null) {
      _json[r'lastUpdate'] = lastUpdate;
    }
    if (lastDiscountUpdate != null) {
      _json[r'lastDiscountUpdate'] = lastDiscountUpdate;
    }
    if (buttonID != null) {
      _json[r'ButtonID'] = buttonID;
    }
    return _json;
  }
