...
class AdvertisingCampaign {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (name != null) {
      ...
      _json[r'endDate'] = endDate;
    if (enabled != null) {
      _json[r'enabled'] = enabled;
    }
    if (startMinute != null) {
      _json[r'startMinute'] = startMinute;
    }
    if (endMinute != null) {
      _json[r'endMinute'] = endMinute;
    }
    if (defaultDiscount != null) {
      _json[r'defaultDiscount'] = defaultDiscount;
    }
      _json[r'discountPrograms'] = discountPrograms;
      _json[r'weekday'] = weekday;
    return _json;
  }
