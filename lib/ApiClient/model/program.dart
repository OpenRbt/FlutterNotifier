...
class Program {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (preflightEnabled != null) {
      _json[r'preflightEnabled'] = preflightEnabled;
    }
    if (isFinishingProgram != null) {
      _json[r'isFinishingProgram'] = isFinishingProgram;
    }
    if (motorSpeedPercent != null) {
      _json[r'motorSpeedPercent'] = motorSpeedPercent;
    }
    if (preflightMotorSpeedPercent != null) {
      _json[r'preflightMotorSpeedPercent'] = preflightMotorSpeedPercent;
    }
      _json[r'relays'] = relays;
      _json[r'preflightRelays'] = preflightRelays;
    return _json;
  }
